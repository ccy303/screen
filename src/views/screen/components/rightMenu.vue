...
<template>
    <div class="screen-right-menu" v-show="visible" :style="style" @mouseleave="mouseleave">
        <ul>
...
<script setup lang="ts">
    ...
    const list = computed(() => {
        ...
        const include: any = {
            tempRect: ["merge", "left", "right", "top", "bottom", "horizontally", "verticalCenter", "del", "lock", "display"],
