                ...
                <el-form size="small">
                    <el-form-item label="版本筛选" v-if="current.optionversion">
                        <el-select v-model="currentOptionVersion" @change="optionVersionChange">
                            <el-tooltip :content="item.versiondescribe" v-for="(item, idx) in current.optionversion" :key="idx">
...
<script setup lang="ts">
    ...
    const optionVersionChange = (id: any) => {
        ...
        // }
        const target = current.value.optionversions.find((item: any) => item.version == id);
