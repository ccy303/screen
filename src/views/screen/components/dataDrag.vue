    ...
    <div class="flex">
        <div class="left">
            ...
            <div class="list-group">
                <draggable :list="data.axis" :group="{ name: 'xAxis', put: false, pull: 'clone' }" item-key="name"
                    @end="onXAxisEnd">
                ...
                <draggable :list="data.data" :group="{ name: 'yAxis', put: false, pull: 'clone' }" item-key="name"
                    @end="onYAxisEnd">
                    <template #item="{ element }">
                        <div class="list-group-item">
                            {{ element.name }}
        ...
        <div class="right">
            <div class="list-group axis">
                ...
                <div class="drag">
                    ...
                    <draggable id="xAxis" style="flex: 1" :list="valueData.xAxis" :group="{ name: 'xAxis' }"
                        item-key="name">
                        <template #item="{ element }">
            ...
            <div class="list-group axis">
                ...
                <div class="drag">
                    ...
                    <draggable id="legend" style="flex: 1" :list="valueData.legend" group="yAxis" item-key="name">
                        <template #item="{ element }">
                            <div class="list-group-item">
                                {{ element.name }}
...
const onYAxisEnd = evt => {
    ...
    if (to.id == "legend") {
        ...
        valueData.value.legend.map(item => {
            const target = valueData.value.yAxis.find(v => v.name == item.name);
