...
<template>
    ...
    >
        ...
        <div class="text" v-if="['text', 'border'].includes(data.type)" :style="getConfigStyle" v-html="newValue || config.text"></div>
            ...
            requestResponse({
                ...
                .then((res: any) => {
                    ...
                    if (typeof afterFetch === "function") {
                        ...
                        requestResult.value = formatScreen(afterFetch, resultData, getDataByType.value);
                    }
                })
                .catch((res: any) => {
                    console.log(res);
